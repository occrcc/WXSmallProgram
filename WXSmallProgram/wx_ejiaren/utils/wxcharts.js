...
var config = {
    ...
    colors: ['#8FC6FF', '#f7a35c', '#434348', '#90ed7d', '#f15c80', '#8085e9'],
...
function drawRadarLabel(angleList, radius, centerPosition, opts, config, context) {
    ...
    context.beginPath();
    context.setFontSize(config.fontSize);
    context.setFillStyle(radarOption.labelColor || '#6A8CC3');
...
function drawRadarDataPoints(series, opts, config, context) {
    ...
    // context.beginPath();
    // context.setLineWidth(1);
    // context.setStrokeStyle(radarOption.gridColor || "#DC143C");
    ...
    var _loop = function _loop(i) {
        ...
        context.beginPath();
        context.setLineWidth(1);
        context.setStrokeStyle(radarOption.gridColor || "#D6E3F5");
